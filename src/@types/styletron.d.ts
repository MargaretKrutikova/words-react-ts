...
declare module 'styletron-react' {
  ...
  type StyleFunction<TProps> = StyletronCssProperties & ((props: TProps, context?: any) => StyletronCssProperties);
  ...
  export function styled<TProps>(base: React.StatelessComponent<TProps> | StyledStatelessComponent<TProps>, style: Style<TProps>): StyledStatelessComponent<TProps>;
  ...
  export function styled<TProps, TComponent extends React.Component<TProps, React.ComponentState>>(base: StyledComponentClass<TProps, TComponent>, style: Style<TProps>): StyledComponentClass<TProps, TComponent>;
  export function styled<TProps extends {}, TComponent extends React.Component<TProps, React.ComponentState>>(base: React.ClassType<TProps, TComponent, React.ComponentClass<TProps>>, style: Style<TProps>): StyledComponentClass<TProps, TComponent>;
}
